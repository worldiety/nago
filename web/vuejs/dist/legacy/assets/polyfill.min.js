(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory();
    global.polyfillMin = mod.exports;
  }
  ...
  Function.prototype.bind || (Function.prototype.bind = function (e) {
    ...
    if (Object.defineProperty) {
      ...
      if (!b || !h) var v = Object.defineProperty,
    ...
    if (Object.defineProperties && !m || (Object.defineProperties = function (e, t) {
      if (m) try {
      ...
      g = O || "undefined" == typeof document ? function () {
        return {
          __proto__: null
        };
      } : function () {
        ...
        var t = function t() {};
        return t.prototype = e, g = function g() {
          return new t();
        }, new t();
    ...
    for (var t = Object(this), n = t.length >>> 0, r = arguments[1], o = r >> 0, i = o < 0 ? Math.max(n + o, 0) : Math.min(o, n), c = arguments[2], l = c === undefined ? n : c >> 0, a = l < 0 ? Math.max(n + l, 0) : Math.min(l, n); i < a;) t[i] = e, i++;
    return t;
    ...
    var t,
      ...
      o = r.length >>> 0;
    if (0 === o) return -1;
    for (t = o - 1, arguments.length > 1 && (t = Number(arguments[1]), t !== t ? t = 0 : 0 != t && t != 1 / 0 && t != -1 / 0 && (t = (t > 0 || -1) * Math.floor(Math.abs(t)))), n = t >= 0 ? Math.min(t, o - 1) : o - Math.abs(t); n >= 0; n--) if (n in r && r[n] === e) return n;
    return -1;
    ...
    if (void 0 === this || null === this) throw new TypeError("Array.prototype.reduceRight called on null or undefined");
    if ("[object Function]" !== Object.prototype.toString.call(e)) throw new TypeError(e + " is not a function");
    for (var t = Object(this), n = t.length >>> 0, r = arguments.length >= 2 ? arguments[1] : void 0, o = 0; o < n; o++) if (o in t && e.call(r, t[o], o, t)) return !0;
    return !1;
  }), function (e) {
    "TextRectangle" in e && !("width" in e.TextRectangle.prototype) && Object.defineProperties(e.TextRectangle.prototype, {
      "width": {
        get: function get() {
    ...
    if ("document" in e) {
      ...
      !function () {
        if ("Element" in e && !Element.prototype.matches) {
          ...
          t.querySelectorAll && (Element.prototype.matches = function (e) {
    ...
    if (!("Event" in e && "function" == typeof e.Event)) {
      ...
      if (e.Event = Window.prototype.Event = function (e, t) {
      ...
      }, n && Object.defineProperty(e.Event, "prototype", {
        configurable: !1,
        enumerable: !1,
        writable: !0,
        value: n
        ...
        var r = function r(n, _r) {
            ...
            o._events || (o._events = {}), o._events[n] || (o._events[n] = function (e) {
              var t,
              ...
              }, e.currentTarget = o, e.target = e.target || e.srcElement || o, e.relatedTarget = e.fromElement ? e.fromElement === e.target ? e.toElement : e.fromElement : null, e.timeStamp = new Date().getTime(), e.clientX && (e.pageX = e.clientX + document.documentElement.scrollLeft, e.pageY = e.clientY + document.documentElement.scrollTop); ++i < c && !e.cancelImmediate;) i in r && (t = r[i], -1 !== n.indexOf(t) && "function" == typeof t && t.call(o, e));
            }, o._events[n].list = [], o.attachEvent && o.attachEvent("on" + n, o._events[n])), o._events[n].list.push(_r);
          },
          o = function o(e, t) {
            var n,
              r = this;
            r._events && r._events[e] && r._events[e].list && -1 !== (n = r._events[e].list.indexOf(t)) && (r._events[e].list.splice(n, 1), r._events[e].list.length || (r.detachEvent && r.detachEvent("on" + e, r._events[e]), delete r._events[e]));
          },
          i = function i(e) {
            ...
            try {
              if (!e.bubbles) {
                e.cancelBubble = !0;
                var _r2 = function r(e) {
                  e.cancelBubble = !0, (t || window).detachEvent("on" + n, _r2);
                };
                this.attachEvent("on" + n, _r2);
              }
    ...
    function getPixelSize(e, t, n, r) {
      var o,
        ...
        c = parseFloat(i),
        l = i.split(/\d/)[0];
      return r = null !== r ? r : /%|em/.test(l) && e.parentElement ? getPixelSize(e.parentElement, e.parentElement.currentStyle, "fontSize", null) : 16, o = "fontSize" === n ? r : /width/i.test(n) ? e.clientWidth : e.clientHeight, "em" === l ? c * r : "in" === l ? 96 * c : "pt" === l ? 96 * c / 72 : "%" === l ? c / 100 * o : c;
    }
    function setShortStyleProperty(e, t) {
      var n = "border" === t ? "Width" : "",
        ...
        i = t + "Bottom" + n,
        c = t + "Left" + n;
      e[t] = (e[r] == e[o] == e[i] == e[c] ? [e[r]] : e[r] == e[i] && e[c] == e[o] ? [e[r], e[o]] : e[c] == e[o] ? [e[r], e[o], e[i]] : [e[r], e[o], e[i], e[c]]).join(" ");
    }
    function CSSStyleDeclaration(e) {
      var t = e.currentStyle || {},
        n = this,
        r = getPixelSize(e, t, "fontSize", null);
      for (var o in t) /width|height|margin.|padding.|border.+W/.test(o) && "auto" !== n[o] ? n[o] = getPixelSize(e, t, o, r) + "px" : "styleFloat" === o ? n["float"] = t[o] : n[o] = t[o];
      return setShortStyleProperty(n, "margin"), setShortStyleProperty(n, "padding"), setShortStyleProperty(n, "border"), n.fontSize = r + "px", n;
    }
    "getComputedStyle" in e && "function" == typeof e.getComputedStyle || (CSSStyleDeclaration.prototype = {
  ...
  }(window), document.head = document.head || document.getElementsByTagName("head")[0], ["abbr", "article", "aside", "audio", "bdi", "canvas", "data", "datalist", "details", "dialog", "figcaption", "figure", "footer", "header", "hgroup", "main", "mark", "meter", "nav", "output", "picture", "progress", "section", "summary", "template", "time", "video"].forEach(function (e) {
