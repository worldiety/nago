			...
			<div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
				<div class="relative transform overflow-hidden rounded-lg bg-background text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
						...
						<div class="sm:flex sm:items-start">
							...
							<div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
								<div class="mt-2">
									...
									<button v-if="error.additionalInformation" class="border border-black bg-background p-0.5 text-sm rounded-md" @click="toggleErrorInfo">Mehr Informationen</button>
					...
					<div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
						<button type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-background px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto" @click="reload">Neu laden</button>
					</div>
				</div>
			</div>
		</div>
