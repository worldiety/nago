<template>
	...
	>
		<div class="flex flex-col text-black rounded-xl shadow-md max-h-screen" :class="dialogClasses" @click.stop>
			<!-- Dialog header -->
			<div class="flex justify-start items-center gap-x-2 bg-primary-98 darkmode:bg-primary-10 rounded-t-xl px-6 py-3">
			...
			<div v-if="ui.footer.v" class="bg-primary-98 darkmode:bg-primary-10 rounded-b-xl px-6 pb-6">
