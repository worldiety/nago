...
export class Box implements Writeable, Readable , Component  {
	...
	constructor(children: AlignedComponents|undefined = undefined, frame: Frame|undefined = undefined, backgroundColor: Color|undefined = undefined, padding: Padding|undefined = undefined, border: Border|undefined = undefined, ) {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.children!== undefined && !this.children.isZero(),this.frame!== undefined && !this.frame.isZero(),this.backgroundColor!== undefined,this.padding!== undefined && !this.padding.isZero(),this.border!== undefined && !this.border.isZero(),];
	...
	isZero(): boolean {
		return (this.children === undefined || this.children.isZero()) && (this.frame === undefined || this.frame.isZero()) && (this.backgroundColor === undefined ) && (this.padding === undefined || this.padding.isZero()) && (this.border === undefined || this.border.isZero())
	}
...
export class UpdateStateValueRequested implements Writeable, Readable , NagoEvent  {
	...
	constructor(statePointer: Ptr|undefined = undefined, functionPointer: Ptr|undefined = undefined, rID: RID|undefined = undefined, value: Str|undefined = undefined, ) {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.statePointer!== undefined,this.functionPointer!== undefined,this.rID!== undefined,this.value!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
	...
	isZero(): boolean {
		return (this.statePointer === undefined ) && (this.functionPointer === undefined ) && (this.rID === undefined ) && (this.value === undefined )
	}
...
export class Shadow implements Writeable, Readable  {
	...
	constructor(color: Color|undefined = undefined, radius: Length|undefined = undefined, x: Length|undefined = undefined, y: Length|undefined = undefined, ) {
		this.color = color;
		this.radius = radius;
		this.x = x;
		this.y = y;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.color!== undefined,this.radius!== undefined,this.x!== undefined,this.y!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
...
export class Border implements Writeable, Readable  {
	...
	constructor(topLeftRadius: Length|undefined = undefined, topRightRadius: Length|undefined = undefined, bottomLeftRadius: Length|undefined = undefined, bottomRightRadius: Length|undefined = undefined, leftWidth: Length|undefined = undefined, topWidth: Length|undefined = undefined, rightWidth: Length|undefined = undefined, bottomWidth: Length|undefined = undefined, leftColor: Color|undefined = undefined, topColor: Color|undefined = undefined, rightColor: Color|undefined = undefined, bottomColor: Color|undefined = undefined, boxShadow: Shadow|undefined = undefined, ) {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.topLeftRadius!== undefined,this.topRightRadius!== undefined,this.bottomLeftRadius!== undefined,this.bottomRightRadius!== undefined,this.leftWidth!== undefined,this.topWidth!== undefined,this.rightWidth!== undefined,this.bottomWidth!== undefined,this.leftColor!== undefined,this.topColor!== undefined,this.rightColor!== undefined,this.bottomColor!== undefined,this.boxShadow!== undefined && !this.boxShadow.isZero(),];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
	...
	isZero(): boolean {
		return (this.topLeftRadius === undefined ) && (this.topRightRadius === undefined ) && (this.bottomLeftRadius === undefined ) && (this.bottomRightRadius === undefined ) && (this.leftWidth === undefined ) && (this.topWidth === undefined ) && (this.rightWidth === undefined ) && (this.bottomWidth === undefined ) && (this.leftColor === undefined ) && (this.topColor === undefined ) && (this.rightColor === undefined ) && (this.bottomColor === undefined ) && (this.boxShadow === undefined || this.boxShadow.isZero())
	}
...
export class Frame implements Writeable, Readable  {
	...
	constructor(minWidth: Length|undefined = undefined, maxWidth: Length|undefined = undefined, minHeight: Length|undefined = undefined, maxHeight: Length|undefined = undefined, width: Length|undefined = undefined, height: Length|undefined = undefined, ) {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.minWidth!== undefined,this.maxWidth!== undefined,this.minHeight!== undefined,this.maxHeight!== undefined,this.width!== undefined,this.height!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
	...
	isZero(): boolean {
		return (this.minWidth === undefined ) && (this.maxWidth === undefined ) && (this.minHeight === undefined ) && (this.maxHeight === undefined ) && (this.width === undefined ) && (this.height === undefined )
	}
...
export class Padding implements Writeable, Readable  {
	...
	constructor(top: Length|undefined = undefined, left: Length|undefined = undefined, right: Length|undefined = undefined, bottom: Length|undefined = undefined, ) {
		this.top = top;
		this.left = left;
		this.right = right;
		this.bottom = bottom;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.top!== undefined,this.left!== undefined,this.right!== undefined,this.bottom!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
	...
	isZero(): boolean {
		return (this.top === undefined ) && (this.left === undefined ) && (this.right === undefined ) && (this.bottom === undefined )
	}
...
export class Checkbox implements Writeable, Readable , Component  {
	...
	constructor(inputValue: Ptr|undefined = undefined, value: Bool|undefined = undefined, disabled: Bool|undefined = undefined, invisible: Bool|undefined = undefined, ) {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.inputValue!== undefined,this.value!== undefined,this.disabled!== undefined,this.invisible!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.UVARINT, 1);
	...
	isZero(): boolean {
		return (this.inputValue === undefined ) && (this.value === undefined ) && (this.disabled === undefined ) && (this.invisible === undefined )
	}
...
export class RootViewAllocationRequested implements Writeable, Readable , NagoEvent  {
	...
	constructor(locale: Locale|undefined = undefined, factory: RootViewID|undefined = undefined, rID: RID|undefined = undefined, values: RootViewParameters|undefined = undefined, ) {
		this.locale = locale;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.locale!== undefined,this.factory!== undefined,this.rID!== undefined,this.values!== undefined && !this.values.isZero(),];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
	...
	isZero(): boolean {
		return (this.locale === undefined ) && (this.factory === undefined ) && (this.rID === undefined ) && (this.values === undefined || this.values.isZero())
	}
...
export class ScopeConfigurationChangeRequested implements Writeable, Readable , NagoEvent  {
	...
	constructor(rID: RID|undefined = undefined, acceptLanguage: Locale|undefined = undefined, windowInfo: WindowInfo|undefined = undefined, ) {
		this.rID = rID;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.rID!== undefined,this.acceptLanguage!== undefined,this.windowInfo!== undefined && !this.windowInfo.isZero(),];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.UVARINT, 1);
	...
	isZero(): boolean {
		return (this.rID === undefined ) && (this.acceptLanguage === undefined ) && (this.windowInfo === undefined || this.windowInfo.isZero())
	}
...
export class WindowInfo implements Writeable, Readable  {
	...
	constructor(width: DP|undefined = undefined, height: DP|undefined = undefined, density: Density|undefined = undefined, sizeClass: WindowSizeClass|undefined = undefined, colorScheme: ColorScheme|undefined = undefined, ) {
		this.width = width;
		this.height = height;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.width!== undefined,this.height!== undefined,this.density!== undefined,this.sizeClass!== undefined,this.colorScheme!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
	...
	isZero(): boolean {
		return (this.width === undefined ) && (this.height === undefined ) && (this.density === undefined ) && (this.sizeClass === undefined ) && (this.colorScheme === undefined )
	}
...
export class ScopeConfigurationChanged implements Writeable, Readable , NagoEvent  {
	...
	constructor(applicationID: Str|undefined = undefined, applicationName: Str|undefined = undefined, applicationVersion: Str|undefined = undefined, availableLocales: Locales|undefined = undefined, appIcon: URI|undefined = undefined, activeLocale: Locale|undefined = undefined, themes: Themes|undefined = undefined, rID: RID|undefined = undefined, ) {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.applicationID!== undefined,this.applicationName!== undefined,this.applicationVersion!== undefined,this.availableLocales!== undefined && !this.availableLocales.isZero(),this.appIcon!== undefined,this.activeLocale!== undefined,this.themes!== undefined && !this.themes.isZero(),this.rID!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
	...
	isZero(): boolean {
		return (this.applicationID === undefined ) && (this.applicationName === undefined ) && (this.applicationVersion === undefined ) && (this.availableLocales === undefined || this.availableLocales.isZero()) && (this.appIcon === undefined ) && (this.activeLocale === undefined ) && (this.themes === undefined || this.themes.isZero()) && (this.rID === undefined )
	}
...
export class Theme implements Writeable, Readable  {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.colors!== undefined && !this.colors.isZero(),this.lengths!== undefined && !this.lengths.isZero(),];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.ARRAY, 1);
	...
	isZero(): boolean {
		return (this.colors === undefined || this.colors.isZero()) && (this.lengths === undefined || this.lengths.isZero())
	}
...
export class Themes implements Writeable, Readable  {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.light!== undefined && !this.light.isZero(),this.dark!== undefined && !this.dark.isZero(),];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
...
export class DateData implements Writeable, Readable  {
	...
	constructor(day: Day|undefined = undefined, month: Month|undefined = undefined, year: Year|undefined = undefined, ) {
		this.day = day;
		this.month = month;
		this.year = year;
	}
...
export class DatePicker implements Writeable, Readable , Component  {
	...
	constructor(label: Str|undefined = undefined, supportingText: Str|undefined = undefined, errorText: Str|undefined = undefined, style: DatePickerStyle|undefined = undefined, value: DateData|undefined = undefined, inputValue: Ptr|undefined = undefined, endValue: DateData|undefined = undefined, endInputValue: Ptr|undefined = undefined, frame: Frame|undefined = undefined, invisible: Bool|undefined = undefined, disabled: Bool|undefined = undefined, ) {
		this.label = label;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.label!== undefined,this.supportingText!== undefined,this.errorText!== undefined,this.style!== undefined,this.value!== undefined && !this.value.isZero(),this.inputValue!== undefined,this.endValue!== undefined && !this.endValue.isZero(),this.endInputValue!== undefined,this.frame!== undefined && !this.frame.isZero(),this.invisible!== undefined,this.disabled!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
...
export class Divider implements Writeable, Readable , Component  {
	...
	constructor(frame: Frame|undefined = undefined, border: Border|undefined = undefined, padding: Padding|undefined = undefined, ) {
		this.frame = frame;
		this.border = border;
		this.padding = padding;
	}
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.frame!== undefined && !this.frame.isZero(),this.border!== undefined && !this.border.isZero(),this.padding!== undefined && !this.padding.isZero(),];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.RECORD, 1);
	...
	isZero(): boolean {
		return (this.frame === undefined || this.frame.isZero()) && (this.border === undefined || this.border.isZero()) && (this.padding === undefined || this.padding.isZero())
	}
...
export class Font implements Writeable, Readable  {
	...
	constructor(name: Str|undefined = undefined, size: Length|undefined = undefined, style: FontStyle|undefined = undefined, weight: FontWeight|undefined = undefined, ) {
		this.name = name;
		this.size = size;
		this.style = style;
		this.weight = weight;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.name!== undefined,this.size!== undefined,this.style!== undefined,this.weight!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
	...
	isZero(): boolean {
		return (this.name === undefined ) && (this.size === undefined ) && (this.style === undefined ) && (this.weight === undefined )
	}
...
export class Grid implements Writeable, Readable , Component  {
	...
	constructor(cells: GridCells|undefined = undefined, rows: Uint|undefined = undefined, columns: Uint|undefined = undefined, rowGap: Length|undefined = undefined, colGap: Length|undefined = undefined, frame: Frame|undefined = undefined, backgroundColor: Color|undefined = undefined, padding: Padding|undefined = undefined, border: Border|undefined = undefined, accessibilityLabel: Str|undefined = undefined, font: Font|undefined = undefined, colWidths: Lengths|undefined = undefined, invisible: Bool|undefined = undefined, ) {
		this.cells = cells;
		this.rows = rows;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.cells!== undefined && !this.cells.isZero(),this.rows!== undefined,this.columns!== undefined,this.rowGap!== undefined,this.colGap!== undefined,this.frame!== undefined && !this.frame.isZero(),this.backgroundColor!== undefined,this.padding!== undefined && !this.padding.isZero(),this.border!== undefined && !this.border.isZero(),this.accessibilityLabel!== undefined,this.font!== undefined && !this.font.isZero(),this.colWidths!== undefined && !this.colWidths.isZero(),this.invisible!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.ARRAY, 1);
	...
	isZero(): boolean {
		return (this.cells === undefined || this.cells.isZero()) && (this.rows === undefined ) && (this.columns === undefined ) && (this.rowGap === undefined ) && (this.colGap === undefined ) && (this.frame === undefined || this.frame.isZero()) && (this.backgroundColor === undefined ) && (this.padding === undefined || this.padding.isZero()) && (this.border === undefined || this.border.isZero()) && (this.accessibilityLabel === undefined ) && (this.font === undefined || this.font.isZero()) && (this.colWidths === undefined || this.colWidths.isZero()) && (this.invisible === undefined )
	}
...
export class GridCell implements Writeable, Readable  {
	...
	constructor(body: Component|undefined = undefined, colStart: Uint|undefined = undefined, colEnd: Uint|undefined = undefined, rowStart: Uint|undefined = undefined, rowEnd: Uint|undefined = undefined, colSpan: Uint|undefined = undefined, rowSpan: Uint|undefined = undefined, padding: Padding|undefined = undefined, alignment: Alignment|undefined = undefined, ) {
		this.body = body;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.body!== undefined && !this.body.isZero(),this.colStart!== undefined,this.colEnd!== undefined,this.rowStart!== undefined,this.rowEnd!== undefined,this.colSpan!== undefined,this.rowSpan!== undefined,this.padding!== undefined && !this.padding.isZero(),this.alignment!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			// encode polymorphic enum as 1 element slice
	...
	isZero(): boolean {
		return (this.body === undefined || this.body.isZero()) && (this.colStart === undefined ) && (this.colEnd === undefined ) && (this.rowStart === undefined ) && (this.rowEnd === undefined ) && (this.colSpan === undefined ) && (this.rowSpan === undefined ) && (this.padding === undefined || this.padding.isZero()) && (this.alignment === undefined )
	}
...
export class HStack implements Writeable, Readable , Component  {
	...
	constructor(children: Components|undefined = undefined, gap: Length|undefined = undefined, frame: Frame|undefined = undefined, alignment: Alignment|undefined = undefined, backgroundColor: Color|undefined = undefined, padding: Padding|undefined = undefined, accessibilityLabel: Str|undefined = undefined, border: Border|undefined = undefined, font: Font|undefined = undefined, action: Ptr|undefined = undefined, hoveredBackgroundColor: Color|undefined = undefined, pressedBackgroundColor: Color|undefined = undefined, focusedBackgroundColor: Color|undefined = undefined, hoveredBorder: Border|undefined = undefined, pressedBorder: Border|undefined = undefined, focusedBorder: Border|undefined = undefined, wrap: Bool|undefined = undefined, stylePreset: StylePreset|undefined = undefined, position: Position|undefined = undefined, disabled: Bool|undefined = undefined, invisible: Bool|undefined = undefined, iD: Str|undefined = undefined, ) {
		this.children = children;
		this.gap = gap;
		this.frame = frame;
		this.alignment = alignment;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.children!== undefined && !this.children.isZero(),this.gap!== undefined,this.frame!== undefined && !this.frame.isZero(),this.alignment!== undefined,this.backgroundColor!== undefined,this.padding!== undefined && !this.padding.isZero(),this.accessibilityLabel!== undefined,this.border!== undefined && !this.border.isZero(),this.font!== undefined && !this.font.isZero(),this.action!== undefined,this.hoveredBackgroundColor!== undefined,this.pressedBackgroundColor!== undefined,this.focusedBackgroundColor!== undefined,this.hoveredBorder!== undefined && !this.hoveredBorder.isZero(),this.pressedBorder!== undefined && !this.pressedBorder.isZero(),this.focusedBorder!== undefined && !this.focusedBorder.isZero(),this.wrap!== undefined,this.stylePreset!== undefined,this.position!== undefined && !this.position.isZero(),this.disabled!== undefined,this.invisible!== undefined,this.iD!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.ARRAY, 1);
	...
	isZero(): boolean {
		return (this.children === undefined || this.children.isZero()) && (this.gap === undefined ) && (this.frame === undefined || this.frame.isZero()) && (this.alignment === undefined ) && (this.backgroundColor === undefined ) && (this.padding === undefined || this.padding.isZero()) && (this.accessibilityLabel === undefined ) && (this.border === undefined || this.border.isZero()) && (this.font === undefined || this.font.isZero()) && (this.action === undefined ) && (this.hoveredBackgroundColor === undefined ) && (this.pressedBackgroundColor === undefined ) && (this.focusedBackgroundColor === undefined ) && (this.hoveredBorder === undefined || this.hoveredBorder.isZero()) && (this.pressedBorder === undefined || this.pressedBorder.isZero()) && (this.focusedBorder === undefined || this.focusedBorder.isZero()) && (this.wrap === undefined ) && (this.stylePreset === undefined ) && (this.position === undefined || this.position.isZero()) && (this.disabled === undefined ) && (this.invisible === undefined ) && (this.iD === undefined )
	}
...
export class Position implements Writeable, Readable  {
	...
	constructor(kind: PositionType|undefined = undefined, left: Length|undefined = undefined, top: Length|undefined = undefined, right: Length|undefined = undefined, bottom: Length|undefined = undefined, ) {
		this.kind = kind;
		this.left = left;
		this.top = top;
		this.right = right;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.kind!== undefined,this.left!== undefined,this.top!== undefined,this.right!== undefined,this.bottom!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.UVARINT, 1);
	...
	isZero(): boolean {
		return (this.kind === undefined ) && (this.left === undefined ) && (this.top === undefined ) && (this.right === undefined ) && (this.bottom === undefined )
	}
...
export class Img implements Writeable, Readable , Component  {
	...
	constructor(uri: URI|undefined = undefined, accessibilityLabel: Str|undefined = undefined, border: Border|undefined = undefined, frame: Frame|undefined = undefined, padding: Padding|undefined = undefined, sVG: SVG|undefined = undefined, fillColor: Color|undefined = undefined, strokeColor: Color|undefined = undefined, invisible: Bool|undefined = undefined, ) {
		this.uri = uri;
		this.accessibilityLabel = accessibilityLabel;
		this.border = border;
		this.frame = frame;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.uri!== undefined,this.accessibilityLabel!== undefined,this.border!== undefined && !this.border.isZero(),this.frame!== undefined && !this.frame.isZero(),this.padding!== undefined && !this.padding.isZero(),this.sVG!== undefined,this.fillColor!== undefined,this.strokeColor!== undefined,this.invisible!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
	...
	isZero(): boolean {
		return (this.uri === undefined ) && (this.accessibilityLabel === undefined ) && (this.border === undefined || this.border.isZero()) && (this.frame === undefined || this.frame.isZero()) && (this.padding === undefined || this.padding.isZero()) && (this.sVG === undefined ) && (this.fillColor === undefined ) && (this.strokeColor === undefined ) && (this.invisible === undefined )
	}
...
export class FileImportRequested implements Writeable, Readable , NagoEvent  {
	...
	constructor(iD: Str|undefined = undefined, scopeID: Str|undefined = undefined, multiple: Bool|undefined = undefined, maxBytes: Uint|undefined = undefined, allowedMimeTypes: Strings|undefined = undefined, ) {
		this.iD = iD;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.iD!== undefined,this.scopeID!== undefined,this.multiple!== undefined,this.maxBytes!== undefined,this.allowedMimeTypes!== undefined && !this.allowedMimeTypes.isZero(),];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
	...
	isZero(): boolean {
		return (this.iD === undefined ) && (this.scopeID === undefined ) && (this.multiple === undefined ) && (this.maxBytes === undefined ) && (this.allowedMimeTypes === undefined || this.allowedMimeTypes.isZero())
	}
...
export class KeyboardOptions implements Writeable, Readable  {
	...
	constructor(capitalization: Bool|undefined = undefined, autoCorrectEnabled: Bool|undefined = undefined, keyboardType: KeyboardType|undefined = undefined, ) {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.capitalization!== undefined,this.autoCorrectEnabled!== undefined,this.keyboardType!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.UVARINT, 1);
	...
	isZero(): boolean {
		return (this.capitalization === undefined ) && (this.autoCorrectEnabled === undefined ) && (this.keyboardType === undefined )
	}
...
export class Modal implements Writeable, Readable , Component  {
	...
	constructor(content: Component|undefined = undefined, onDismissRequest: Ptr|undefined = undefined, modalType: ModalType|undefined = undefined, top: Length|undefined = undefined, left: Length|undefined = undefined, right: Length|undefined = undefined, bottom: Length|undefined = undefined, ) {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.content!== undefined && !this.content.isZero(),this.onDismissRequest!== undefined,this.modalType!== undefined,this.top!== undefined,this.left!== undefined,this.right!== undefined,this.bottom!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			// encode polymorphic enum as 1 element slice
	...
	isZero(): boolean {
		return (this.content === undefined || this.content.isZero()) && (this.onDismissRequest === undefined ) && (this.modalType === undefined ) && (this.top === undefined ) && (this.left === undefined ) && (this.right === undefined ) && (this.bottom === undefined )
	}
...
export class PasswordField implements Writeable, Readable , Component  {
	...
	constructor(label: Str|undefined = undefined, supportingText: Str|undefined = undefined, errorText: Str|undefined = undefined, value: Str|undefined = undefined, frame: Frame|undefined = undefined, inputValue: Ptr|undefined = undefined, style: TextFieldStyle|undefined = undefined, debounceTime: Duration|undefined = undefined, lines: Uint|undefined = undefined, disabled: Bool|undefined = undefined, disableAutocomplete: Bool|undefined = undefined, disableDebounce: Bool|undefined = undefined, invisible: Bool|undefined = undefined, revealed: Bool|undefined = undefined, ) {
		this.label = label;
		this.supportingText = supportingText;
		this.errorText = errorText;
		this.value = value;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.label!== undefined,this.supportingText!== undefined,this.errorText!== undefined,this.value!== undefined,this.frame!== undefined && !this.frame.isZero(),this.inputValue!== undefined,this.style!== undefined,this.debounceTime!== undefined,this.lines!== undefined,this.disabled!== undefined,this.disableAutocomplete!== undefined,this.disableDebounce!== undefined,this.invisible!== undefined,this.revealed!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
...
export class Scaffold implements Writeable, Readable , Component  {
	...
	constructor(body: Component|undefined = undefined, logo: Component|undefined = undefined, menu: ScaffoldMenuEntries|undefined = undefined, alignment: ScaffoldAlignment|undefined = undefined, ) {
		this.body = body;
		this.logo = logo;
		this.menu = menu;
		this.alignment = alignment;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.body!== undefined && !this.body.isZero(),this.logo!== undefined && !this.logo.isZero(),this.menu!== undefined && !this.menu.isZero(),this.alignment!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			// encode polymorphic enum as 1 element slice
	...
	isZero(): boolean {
		return (this.body === undefined || this.body.isZero()) && (this.logo === undefined || this.logo.isZero()) && (this.menu === undefined || this.menu.isZero()) && (this.alignment === undefined )
	}
...
export class ScaffoldMenuEntry implements Writeable, Readable  {
	...
	constructor(icon: Component|undefined = undefined, iconActive: Component|undefined = undefined, title: Str|undefined = undefined, action: Ptr|undefined = undefined, rootView: RootViewID|undefined = undefined, menu: ScaffoldMenuEntries|undefined = undefined, badge: Str|undefined = undefined, expanded: Bool|undefined = undefined, ) {
		this.icon = icon;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.icon!== undefined && !this.icon.isZero(),this.iconActive!== undefined && !this.iconActive.isZero(),this.title!== undefined,this.action!== undefined,this.rootView!== undefined,this.menu!== undefined && !this.menu.isZero(),this.badge!== undefined,this.expanded!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			// encode polymorphic enum as 1 element slice
	...
	isZero(): boolean {
		return (this.icon === undefined || this.icon.isZero()) && (this.iconActive === undefined || this.iconActive.isZero()) && (this.title === undefined ) && (this.action === undefined ) && (this.rootView === undefined ) && (this.menu === undefined || this.menu.isZero()) && (this.badge === undefined ) && (this.expanded === undefined )
	}
...
export class ScrollView implements Writeable, Readable , Component  {
	...
	constructor(content: Component|undefined = undefined, border: Border|undefined = undefined, frame: Frame|undefined = undefined, padding: Padding|undefined = undefined, backgroundColor: Color|undefined = undefined, axis: ScrollViewAxis|undefined = undefined, invisible: Bool|undefined = undefined, ) {
		this.content = content;
		this.border = border;
		this.frame = frame;
		this.padding = padding;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.content!== undefined && !this.content.isZero(),this.border!== undefined && !this.border.isZero(),this.frame!== undefined && !this.frame.isZero(),this.padding!== undefined && !this.padding.isZero(),this.backgroundColor!== undefined,this.axis!== undefined,this.invisible!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			// encode polymorphic enum as 1 element slice
	...
	isZero(): boolean {
		return (this.content === undefined || this.content.isZero()) && (this.border === undefined || this.border.isZero()) && (this.frame === undefined || this.frame.isZero()) && (this.padding === undefined || this.padding.isZero()) && (this.backgroundColor === undefined ) && (this.axis === undefined ) && (this.invisible === undefined )
	}
...
export class Resource implements Writeable, Readable  {
	...
	constructor(name: Str|undefined = undefined, uRI: URI|undefined = undefined, mimeType: Str|undefined = undefined, ) {
		this.name = name;
		this.uRI = uRI;
...
export class Spacer implements Writeable, Readable , Component  {
	...
	constructor(frame: Frame|undefined = undefined, border: Border|undefined = undefined, backgroundColor: Color|undefined = undefined, ) {
		this.frame = frame;
		this.border = border;
		this.backgroundColor = backgroundColor;
	}
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.frame!== undefined && !this.frame.isZero(),this.border!== undefined && !this.border.isZero(),this.backgroundColor!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.RECORD, 1);
	...
	isZero(): boolean {
		return (this.frame === undefined || this.frame.isZero()) && (this.border === undefined || this.border.isZero()) && (this.backgroundColor === undefined )
	}
...
export class Table implements Writeable, Readable , Component  {
	...
	constructor(header: TableHeader|undefined = undefined, rows: TableRows|undefined = undefined, frame: Frame|undefined = undefined, backgroundColor: Color|undefined = undefined, border: Border|undefined = undefined, defaultCellPadding: Padding|undefined = undefined, rowDividerColor: Color|undefined = undefined, headerDividerColor: Color|undefined = undefined, ) {
		this.header = header;
		this.rows = rows;
		this.frame = frame;
		this.backgroundColor = backgroundColor;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.header!== undefined && !this.header.isZero(),this.rows!== undefined && !this.rows.isZero(),this.frame!== undefined && !this.frame.isZero(),this.backgroundColor!== undefined,this.border!== undefined && !this.border.isZero(),this.defaultCellPadding!== undefined && !this.defaultCellPadding.isZero(),this.rowDividerColor!== undefined,this.headerDividerColor!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.RECORD, 1);
...
export class TableCell implements Writeable, Readable  {
	...
	constructor(content: Component|undefined = undefined, rowSpan: Uint|undefined = undefined, colSpan: Uint|undefined = undefined, alignment: Alignment|undefined = undefined, backgroundColor: Color|undefined = undefined, hoveredBackgroundColor: Color|undefined = undefined, padding: Padding|undefined = undefined, border: Border|undefined = undefined, action: Ptr|undefined = undefined, hovered: Bool|undefined = undefined, ) {
		this.content = content;
		this.rowSpan = rowSpan;
		this.colSpan = colSpan;
		this.alignment = alignment;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.content!== undefined && !this.content.isZero(),this.rowSpan!== undefined,this.colSpan!== undefined,this.alignment!== undefined,this.backgroundColor!== undefined,this.hoveredBackgroundColor!== undefined,this.padding!== undefined && !this.padding.isZero(),this.border!== undefined && !this.border.isZero(),this.action!== undefined,this.hovered!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			// encode polymorphic enum as 1 element slice
...
export class TableColumn implements Writeable, Readable  {
	...
	constructor(content: Component|undefined = undefined, colSpan: Uint|undefined = undefined, width: Length|undefined = undefined, alignment: Alignment|undefined = undefined, cellBackgroundColor: Color|undefined = undefined, cellAction: Ptr|undefined = undefined, cellPadding: Padding|undefined = undefined, cellBorder: Border|undefined = undefined, cellHoveredBackgroundColor: Color|undefined = undefined, cellHovered: Bool|undefined = undefined, ) {
		this.content = content;
		this.colSpan = colSpan;
		this.width = width;
		this.alignment = alignment;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.content!== undefined && !this.content.isZero(),this.colSpan!== undefined,this.width!== undefined,this.alignment!== undefined,this.cellBackgroundColor!== undefined,this.cellAction!== undefined,this.cellPadding!== undefined && !this.cellPadding.isZero(),this.cellBorder!== undefined && !this.cellBorder.isZero(),this.cellHoveredBackgroundColor!== undefined,this.cellHovered!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			// encode polymorphic enum as 1 element slice
...
export class TableRow implements Writeable, Readable  {
	...
	constructor(cells: TableCells|undefined = undefined, height: Length|undefined = undefined, backgroundColor: Color|undefined = undefined, hoveredBackgroundColor: Color|undefined = undefined, action: Ptr|undefined = undefined, hovered: Bool|undefined = undefined, ) {
		this.cells = cells;
		this.height = height;
		this.backgroundColor = backgroundColor;
		this.hoveredBackgroundColor = hoveredBackgroundColor;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.cells!== undefined && !this.cells.isZero(),this.height!== undefined,this.backgroundColor!== undefined,this.hoveredBackgroundColor!== undefined,this.action!== undefined,this.hovered!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.ARRAY, 1);
	...
	isZero(): boolean {
		return (this.cells === undefined || this.cells.isZero()) && (this.height === undefined ) && (this.backgroundColor === undefined ) && (this.hoveredBackgroundColor === undefined ) && (this.action === undefined ) && (this.hovered === undefined )
	}
...
export class TextView implements Writeable, Readable , Component  {
	...
	constructor(value: Str|undefined = undefined, color: Color|undefined = undefined, backgroundColor: Color|undefined = undefined, onClick: Ptr|undefined = undefined, onHoverStart: Ptr|undefined = undefined, onHoverEnd: Ptr|undefined = undefined, border: Border|undefined = undefined, padding: Padding|undefined = undefined, frame: Frame|undefined = undefined, accessibilityLabel: Str|undefined = undefined, font: Font|undefined = undefined, action: Ptr|undefined = undefined, textAlignment: TextAlignment|undefined = undefined, hoveredBackgroundColor: Color|undefined = undefined, pressedBackgroundColor: Color|undefined = undefined, focusedBackgroundColor: Color|undefined = undefined, hoveredBorder: Border|undefined = undefined, pressedBorder: Border|undefined = undefined, focusedBorder: Border|undefined = undefined, lineBreak: Bool|undefined = undefined, invisible: Bool|undefined = undefined, ) {
		this.value = value;
		this.color = color;
		this.backgroundColor = backgroundColor;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.value!== undefined,this.color!== undefined,this.backgroundColor!== undefined,this.onClick!== undefined,this.onHoverStart!== undefined,this.onHoverEnd!== undefined,this.border!== undefined && !this.border.isZero(),this.padding!== undefined && !this.padding.isZero(),this.frame!== undefined && !this.frame.isZero(),this.accessibilityLabel!== undefined,this.font!== undefined && !this.font.isZero(),this.action!== undefined,this.textAlignment!== undefined,this.hoveredBackgroundColor!== undefined,this.pressedBackgroundColor!== undefined,this.focusedBackgroundColor!== undefined,this.hoveredBorder!== undefined && !this.hoveredBorder.isZero(),this.pressedBorder!== undefined && !this.pressedBorder.isZero(),this.focusedBorder!== undefined && !this.focusedBorder.isZero(),this.lineBreak!== undefined,this.invisible!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
...
export class TextField implements Writeable, Readable , Component  {
	...
	constructor(label: Str|undefined = undefined, supportingText: Str|undefined = undefined, errorText: Str|undefined = undefined, value: Str|undefined = undefined, frame: Frame|undefined = undefined, inputValue: Ptr|undefined = undefined, style: TextFieldStyle|undefined = undefined, leading: Component|undefined = undefined, trailing: Component|undefined = undefined, debounceTime: Duration|undefined = undefined, lines: Uint|undefined = undefined, keyboardOptions: KeyboardOptions|undefined = undefined, disabled: Bool|undefined = undefined, disableAutocomplete: Bool|undefined = undefined, disableDebounce: Bool|undefined = undefined, invisible: Bool|undefined = undefined, revealed: Bool|undefined = undefined, ) {
		this.label = label;
		this.supportingText = supportingText;
		this.errorText = errorText;
		this.value = value;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.label!== undefined,this.supportingText!== undefined,this.errorText!== undefined,this.value!== undefined,this.frame!== undefined && !this.frame.isZero(),this.inputValue!== undefined,this.style!== undefined,this.leading!== undefined && !this.leading.isZero(),this.trailing!== undefined && !this.trailing.isZero(),this.debounceTime!== undefined,this.lines!== undefined,this.keyboardOptions!== undefined && !this.keyboardOptions.isZero(),this.disabled!== undefined,this.disableAutocomplete!== undefined,this.disableDebounce!== undefined,this.invisible!== undefined,this.revealed!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
...
export class TextLayout implements Writeable, Readable , Component  {
	...
	constructor(children: Components|undefined = undefined, border: Border|undefined = undefined, frame: Frame|undefined = undefined, backgroundColor: Color|undefined = undefined, padding: Padding|undefined = undefined, accessibilityLabel: Str|undefined = undefined, font: Font|undefined = undefined, action: Ptr|undefined = undefined, textAlignment: TextAlignment|undefined = undefined, invisible: Bool|undefined = undefined, ) {
		this.children = children;
		this.border = border;
		this.frame = frame;
		this.backgroundColor = backgroundColor;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.children!== undefined && !this.children.isZero(),this.border!== undefined && !this.border.isZero(),this.frame!== undefined && !this.frame.isZero(),this.backgroundColor!== undefined,this.padding!== undefined && !this.padding.isZero(),this.accessibilityLabel!== undefined,this.font!== undefined && !this.font.isZero(),this.action!== undefined,this.textAlignment!== undefined,this.invisible!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.ARRAY, 1);
...
export class VStack implements Writeable, Readable , Component  {
	...
	constructor(children: Components|undefined = undefined, gap: Length|undefined = undefined, frame: Frame|undefined = undefined, alignment: Alignment|undefined = undefined, backgroundColor: Color|undefined = undefined, padding: Padding|undefined = undefined, accessibilityLabel: Str|undefined = undefined, border: Border|undefined = undefined, font: Font|undefined = undefined, action: Ptr|undefined = undefined, hoveredBackgroundColor: Color|undefined = undefined, pressedBackgroundColor: Color|undefined = undefined, focusedBackgroundColor: Color|undefined = undefined, hoveredBorder: Border|undefined = undefined, pressedBorder: Border|undefined = undefined, focusedBorder: Border|undefined = undefined, stylePreset: StylePreset|undefined = undefined, position: Position|undefined = undefined, disabled: Bool|undefined = undefined, invisible: Bool|undefined = undefined, ) {
		this.children = children;
		this.gap = gap;
		this.frame = frame;
		this.alignment = alignment;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.children!== undefined && !this.children.isZero(),this.gap!== undefined,this.frame!== undefined && !this.frame.isZero(),this.alignment!== undefined,this.backgroundColor!== undefined,this.padding!== undefined && !this.padding.isZero(),this.accessibilityLabel!== undefined,this.border!== undefined && !this.border.isZero(),this.font!== undefined && !this.font.isZero(),this.action!== undefined,this.hoveredBackgroundColor!== undefined,this.pressedBackgroundColor!== undefined,this.focusedBackgroundColor!== undefined,this.hoveredBorder!== undefined && !this.hoveredBorder.isZero(),this.pressedBorder!== undefined && !this.pressedBorder.isZero(),this.focusedBorder!== undefined && !this.focusedBorder.isZero(),this.stylePreset!== undefined,this.position!== undefined && !this.position.isZero(),this.disabled!== undefined,this.invisible!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.ARRAY, 1);
...
export class UpdateStateValues2Requested implements Writeable, Readable , NagoEvent  {
	...
	constructor(statePtr0: Ptr|undefined = undefined, value0: Str|undefined = undefined, statePtr1: Ptr|undefined = undefined, value1: Str|undefined = undefined, functionPointer: Ptr|undefined = undefined, rID: RID|undefined = undefined, ) {
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.statePtr0!== undefined,this.value0!== undefined,this.statePtr1!== undefined,this.value1!== undefined,this.functionPointer!== undefined,this.rID!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.UVARINT, 1);
	...
	isZero(): boolean {
		return (this.statePtr0 === undefined ) && (this.value0 === undefined ) && (this.statePtr1 === undefined ) && (this.value1 === undefined ) && (this.functionPointer === undefined ) && (this.rID === undefined )
	}
...
export class OpenHttpFlow implements Writeable, Readable , NagoEvent  {
	...
	constructor(url: URI|undefined = undefined, redirectTarget: Str|undefined = undefined, redirectNavigation: Str|undefined = undefined, session: Str|undefined = undefined, ) {
		this.url = url;
	...
	write(writer: BinaryWriter): void {
		const fields = [false,this.url!== undefined,this.redirectTarget!== undefined,this.redirectNavigation!== undefined,this.session!== undefined,];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
	...
	isZero(): boolean {
		return (this.url === undefined ) && (this.redirectTarget === undefined ) && (this.redirectNavigation === undefined ) && (this.session === undefined )
	}
