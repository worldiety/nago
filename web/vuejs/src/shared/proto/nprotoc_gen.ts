...
export class Scaffold implements Writeable, Readable, Component {
	...
	constructor(
		...
		height: Length | undefined = undefined,
		bodyFullSize: Bool | undefined = undefined
	) {
		this.body = body;
		this.logo = logo;
		this.menu = menu;
		...
		this.footer = footer;
		this.height = height;
		this.bodyFullSize = bodyFullSize;
	}
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				...
				case 9: {
					this.bodyFullSize = readBool(reader);
					break;
				}
				default:
					throw new Error(`Unknown field ID: ${fieldHeader.fieldId}`);
	...
	write(writer: BinaryWriter): void {
		...
		if (fields[9]) {
			writer.writeFieldHeader(Shapes.UVARINT, 9);
			writeBool(writer, this.bodyFullSize!); // typescript linters cannot see, that we already checked this properly above
		}
	}
...
export class TextView implements Writeable, Readable, Component {
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				...
				case 23: {
					this.hyphens = readString(reader);
					break;
				}
				case 24: {
	...
	write(writer: BinaryWriter): void {
		...
		if (fields[23]) {
			...
			writeString(writer, this.hyphens!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[24]) {
...
export class BarChartMarker implements Writeable, Readable {
	...
	constructor(
		label: Str | undefined = undefined,
		seriesIndex: Int | undefined = undefined,
		dataPointIndex: Int | undefined = undefined,
		value: Str | undefined = undefined,
		width: Int | undefined = undefined,
		height: Int | undefined = undefined,
		round: Bool | undefined = undefined,
		dashed: Bool | undefined = undefined,
		color: Color | undefined = undefined
	) {
		this.label = label;
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				...
				case 2: {
					this.seriesIndex = readSint(reader);
					break;
				}
				case 3: {
					this.dataPointIndex = readSint(reader);
					break;
				}
				case 4: {
					this.value = readString(reader);
				...
				case 7: {
					this.round = readBool(reader);
					break;
				}
				case 8: {
					this.dashed = readBool(reader);
					break;
				}
				case 9: {
					this.color = readString(reader);
	...
	write(writer: BinaryWriter): void {
		...
		if (fields[2]) {
			writer.writeFieldHeader(Shapes.VARINT, 2);
			writeSint(writer, this.seriesIndex!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[3]) {
			writer.writeFieldHeader(Shapes.VARINT, 3);
			writeSint(writer, this.dataPointIndex!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[4]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 4);
			writeString(writer, this.value!); // typescript linters cannot see, that we already checked this properly above
		...
		if (fields[5]) {
			writer.writeFieldHeader(Shapes.VARINT, 5);
		...
		if (fields[7]) {
			writer.writeFieldHeader(Shapes.UVARINT, 7);
			writeBool(writer, this.round!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[8]) {
			writer.writeFieldHeader(Shapes.UVARINT, 8);
			writeBool(writer, this.dashed!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[9]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 9);
			writeString(writer, this.color!); // typescript linters cannot see, that we already checked this properly above
...
export class LineChart implements Writeable, Readable, Component {
	public chart?: Chart;
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 158);
		return;
	}
	isComponent(): void {}
}

export type LineChartCurve = number;
function writeTypeHeaderLineChartCurve(dst: BinaryWriter): void {
	dst.writeTypeHeader(Shapes.UVARINT, 159);
	return;
}
// companion enum containing all defined constants for LineChartCurve
export enum LineChartCurveValues {
	LineChartCurveStraight = 0,
	LineChartCurveSmooth = 1,
	LineChartCurveStepline = 2,
}

// ChartSeriesArray is an array of series which hold the data for the chart.
export class ChartSeriesArray implements Writeable, Readable {
	public value: ChartSeries[];

	constructor(value: ChartSeries[] = []) {
		this.value = value;
	}
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < count; i++) {
			const obj = unmarshal(reader); // Read and unmarshal each component
			values.push(obj as any as ChartSeries); // Cast and add to the array
		}

		this.value = values;
	}
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.ARRAY, 160);
		return;
	}
}

export type ChartSeriesType = number;
function writeTypeHeaderChartSeriesType(dst: BinaryWriter): void {
	dst.writeTypeHeader(Shapes.UVARINT, 161);
	return;
}
// companion enum containing all defined constants for ChartSeriesType
export enum ChartSeriesTypeValues {
	ChartSeriesTypeLine = 0,
	ChartSeriesTypeColumn = 1,
	ChartSeriesTypeArea = 2,
}

// ChartDataPoints is an array of values of the chart.
export class ChartDataPoints implements Writeable, Readable {
	public value: ChartDataPoint[];

	constructor(value: ChartDataPoint[] = []) {
		this.value = value;
	}
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < count; i++) {
			const obj = unmarshal(reader); // Read and unmarshal each component
			values.push(obj as any as ChartDataPoint); // Cast and add to the array
		}

		this.value = values;
	}
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.ARRAY, 162);
		return;
	}
}

export class ChartDataPoint implements Writeable, Readable {
	public x?: Str;

	public y?: Float;

	constructor(x: Str | undefined = undefined, y: Float | undefined = undefined) {
		this.x = x;
		this.y = y;
	}
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 163);
		return;
	}
}

export class ChartSeries implements Writeable, Readable {
	public label?: Str;

	public type?: ChartSeriesType;

	public dataPoints?: ChartDataPoints;

	constructor(
		label: Str | undefined = undefined,
		type: ChartSeriesType | undefined = undefined,
		dataPoints: ChartDataPoints | undefined = undefined
	) {
		this.label = label;
		this.type = type;
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				...
				case 3: {
					this.dataPoints = new ChartDataPoints();
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 164);
		return;
	}
}
...
export class Chart implements Writeable, Readable {
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				...
				case 6: {
					this.xAxisTitle = readString(reader);
					break;
				}
				case 7: {
	...
	write(writer: BinaryWriter): void {
		...
		if (fields[6]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 6);
			writeString(writer, this.xAxisTitle!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[7]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 7);
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 166);
		return;
	}
}
...
export class Background implements Writeable, Readable {
	...
	public image?: Strings;

	// In percent 0-100.
	public positionX?: Uint;

	// In percent 0-100.
	public positionY?: Uint;
	...
	constructor(
		image: Strings | undefined = undefined,
		positionX: Uint | undefined = undefined,
		positionY: Uint | undefined = undefined,
		repeat: Str | undefined = undefined,
		size: Str | undefined = undefined
	) {
		this.image = image;
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				case 1: {
					this.image = new Strings();
					this.image.read(reader);
					break;
				}
				case 2: {
					this.positionX = readInt(reader);
					break;
				}
				case 3: {
					this.positionY = readInt(reader);
					break;
				}
				case 4: {
					this.repeat = readString(reader);
					break;
				}
				case 5: {
					this.size = readString(reader);
	...
	write(writer: BinaryWriter): void {
		const fields = [
			false,
			this.image !== undefined && !this.image.isZero(),
		...
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.ARRAY, 1);
			this.image!.write(writer); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[2]) {
			writer.writeFieldHeader(Shapes.UVARINT, 2);
			writeInt(writer, this.positionX!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[3]) {
			writer.writeFieldHeader(Shapes.UVARINT, 3);
			writeInt(writer, this.positionY!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[4]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 4);
			writeString(writer, this.repeat!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[5]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 5);
			writeString(writer, this.size!); // typescript linters cannot see, that we already checked this properly above
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 177);
		return;
	}
}
...
export class FlowChart implements Writeable, Readable, Component {
	public inputValue?: Ptr;

	public value?: FlowChartModel;
	...
	public nodesConnectable?: Bool;

	public edgesEditable?: Bool;

	public elementsSelectable?: Bool;

	public orientation?: Orientation;

	public customContents?: FlowChartCustomContents;
	...
	constructor(
		...
		elementsSelectable: Bool | undefined = undefined,
		orientation: Orientation | undefined = undefined,
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				...
				case 5: {
					this.nodesDraggable = readBool(reader);
					break;
				}
				case 6: {
					this.nodesConnectable = readBool(reader);
					break;
				}
				case 7: {
					this.edgesEditable = readBool(reader);
					break;
				}
				case 8: {
					this.elementsSelectable = readBool(reader);
					break;
				}
				case 9: {
					this.orientation = readInt(reader);
				...
				case 10: {
					this.customContents = new FlowChartCustomContents();
					this.customContents.read(reader);
					break;
				}
				case 11: {
					this.minZoom = readFloat(reader);
					break;
				}
				case 12: {
				...
				case 14: {
					this.toolbar = new FlowChartToolbar();
	...
	write(writer: BinaryWriter): void {
		const fields = [
			...
			this.elementsSelectable !== undefined,
			this.orientation !== undefined,
		...
		if (fields[5]) {
			writer.writeFieldHeader(Shapes.UVARINT, 5);
			writeBool(writer, this.nodesDraggable!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[6]) {
			writer.writeFieldHeader(Shapes.UVARINT, 6);
			writeBool(writer, this.nodesConnectable!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[7]) {
			writer.writeFieldHeader(Shapes.UVARINT, 7);
			writeBool(writer, this.edgesEditable!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[8]) {
			writer.writeFieldHeader(Shapes.UVARINT, 8);
			writeBool(writer, this.elementsSelectable!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[9]) {
			writer.writeFieldHeader(Shapes.UVARINT, 9);
			writeInt(writer, this.orientation!); // typescript linters cannot see, that we already checked this properly above
		...
		if (fields[10]) {
			writer.writeFieldHeader(Shapes.ARRAY, 10);
			this.customContents!.write(writer); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[11]) {
			writer.writeFieldHeader(Shapes.F64, 11);
			writeFloat(writer, this.minZoom!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[12]) {
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 233);
		return;
	}
	isComponent(): void {}
}
...
export class FlowChartPoint implements Writeable, Readable {
	public x?: Float;

	public y?: Float;

	constructor(x: Float | undefined = undefined, y: Float | undefined = undefined) {
		this.x = x;
		this.y = y;
	}
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 234);
		return;
	}
}

// FlowChartNodeType describes the semantic role and default visualization of a flow chart node.
export type FlowChartNodeType = number;
function writeTypeHeaderFlowChartNodeType(dst: BinaryWriter): void {
	dst.writeTypeHeader(Shapes.UVARINT, 235);
	return;
}
// companion enum containing all defined constants for FlowChartNodeType
export enum FlowChartNodeTypeValues {
	FlowChartNodeTypeDefault = 0,
	FlowChartNodeTypeStart = 1,
	FlowChartNodeTypeEnd = 2,
}

// FlowChartNode represents a single positioned node in a flow chart.
export class FlowChartNode implements Writeable, Readable {
	public id?: Str;
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 236);
		return;
	}
}

// FlowChartNodes is the list of all nodes in a flow chart.
export class FlowChartNodes implements Writeable, Readable {
	public value: FlowChartNode[];

	constructor(value: FlowChartNode[] = []) {
		this.value = value;
	}
	...
	read(reader: BinaryReader): void {
		const count = reader.readUvarint(); // Read the length of the array
		const values: FlowChartNode[] = [];

		for (let i = 0; i < count; i++) {
			const obj = unmarshal(reader); // Read and unmarshal each component
			values.push(obj as any as FlowChartNode); // Cast and add to the array
		}

		this.value = values;
	}
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.ARRAY, 237);
		return;
	}
}

// FlowChartEdgeStyle describes the stroke style of an edge.
export type FlowChartEdgeStyle = number;
function writeTypeHeaderFlowChartEdgeStyle(dst: BinaryWriter): void {
	dst.writeTypeHeader(Shapes.UVARINT, 238);
	return;
}
// companion enum containing all defined constants for FlowChartEdgeStyle
export enum FlowChartEdgeStyleValues {
	FlowChartEdgeStyleSolid = 0,
	FlowChartEdgeStyleDashed = 1,
	FlowChartEdgeStyleDotted = 2,
}

// FlowChartEdgeMarker defines the decoration rendered at the start or end of an edge.
export type FlowChartEdgeMarker = number;
function writeTypeHeaderFlowChartEdgeMarker(dst: BinaryWriter): void {
	dst.writeTypeHeader(Shapes.UVARINT, 239);
	return;
}
// companion enum containing all defined constants for FlowChartEdgeMarker
...
export class FlowChartEdge implements Writeable, Readable {
	public id?: Str;

	public sourceNodeId?: Str;

	public targetNodeId?: Str;

	public label?: Str;

	public style?: FlowChartEdgeStyle;
	...
	public markerStart?: FlowChartEdgeMarker;
	...
	constructor(
		...
		targetNodeId: Str | undefined = undefined,
		label: Str | undefined = undefined,
		style: FlowChartEdgeStyle | undefined = undefined,
		color: Color | undefined = undefined,
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				...
				case 2: {
					this.sourceNodeId = readString(reader);
					break;
				}
				case 3: {
					this.targetNodeId = readString(reader);
					break;
				}
				case 4: {
					this.label = readString(reader);
				...
				case 8: {
					this.animated = readBool(reader);
					break;
				}
				case 9: {
					this.markerStart = readInt(reader);
					break;
				}
				case 10: {
	...
	write(writer: BinaryWriter): void {
		...
		if (fields[2]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 2);
			writeString(writer, this.sourceNodeId!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[3]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 3);
			writeString(writer, this.targetNodeId!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[4]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 4);
			writeString(writer, this.label!); // typescript linters cannot see, that we already checked this properly above
		...
		if (fields[8]) {
			writer.writeFieldHeader(Shapes.UVARINT, 8);
			writeBool(writer, this.animated!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[9]) {
			writer.writeFieldHeader(Shapes.UVARINT, 9);
			writeInt(writer, this.markerStart!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[10]) {
			writer.writeFieldHeader(Shapes.UVARINT, 10);
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 240);
		return;
	}
}

// FlowChartEdges is the list of all edges in a flow chart.
export class FlowChartEdges implements Writeable, Readable {
	public value: FlowChartEdge[];

	constructor(value: FlowChartEdge[] = []) {
		this.value = value;
	}
	...
	read(reader: BinaryReader): void {
		const count = reader.readUvarint(); // Read the length of the array
		const values: FlowChartEdge[] = [];

		for (let i = 0; i < count; i++) {
			const obj = unmarshal(reader); // Read and unmarshal each component
			values.push(obj as any as FlowChartEdge); // Cast and add to the array
		}

		this.value = values;
	}
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.ARRAY, 241);
		return;
	}
}

// FlowChartModel represents a node-edge data model for flow charts.
export class FlowChartModel implements Writeable, Readable {
	public nodes?: FlowChartNodes;

	public edges?: FlowChartEdges;

	constructor(nodes: FlowChartNodes | undefined = undefined, edges: FlowChartEdges | undefined = undefined) {
		this.nodes = nodes;
		this.edges = edges;
	}
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				case 1: {
					this.nodes = new FlowChartNodes();
					this.nodes.read(reader);
					break;
				}
				case 2: {
					this.edges = new FlowChartEdges();
					this.edges.read(reader);
					break;
				}
				default:
					throw new Error(`Unknown field ID: ${fieldHeader.fieldId}`);
	...
	write(writer: BinaryWriter): void {
		...
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.ARRAY, 1);
			this.nodes!.write(writer); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[2]) {
			writer.writeFieldHeader(Shapes.ARRAY, 2);
			this.edges!.write(writer); // typescript linters cannot see, that we already checked this properly above
		}
	}

	isZero(): boolean {
		return (this.nodes === undefined || this.nodes.isZero()) && (this.edges === undefined || this.edges.isZero());
	}
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 242);
		return;
	}
}

// FlowChartCustomContent represents the custom content of a node.
export class FlowChartCustomContent implements Writeable, Readable {
	public nodeId?: Str;
	...
	write(writer: BinaryWriter): void {
		...
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.BYTESLICE, 1);
			writeString(writer, this.nodeId!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[2]) {
			// encode polymorphic enum as 1 element slice
			writer.writeFieldHeader(Shapes.ARRAY, 2);
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 243);
		return;
	}
}

// FlowChartCustomContents is the list of all custom contents in a flow chart.
export class FlowChartCustomContents implements Writeable, Readable {
	public value: FlowChartCustomContent[];

	constructor(value: FlowChartCustomContent[] = []) {
		this.value = value;
	}
	...
	read(reader: BinaryReader): void {
		const count = reader.readUvarint(); // Read the length of the array
		const values: FlowChartCustomContent[] = [];

		for (let i = 0; i < count; i++) {
			const obj = unmarshal(reader); // Read and unmarshal each component
			values.push(obj as any as FlowChartCustomContent); // Cast and add to the array
		}

		this.value = values;
	}
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.ARRAY, 244);
		return;
	}
}
...
export class FlowChartActionData implements Writeable, Readable {
	...
	constructor(
		...
		rightClick: Bool | undefined = undefined
	) {
		this.node = node;
		this.edge = edge;
		this.viewX = viewX;
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				...
				case 9: {
					this.rightClick = readBool(reader);
					break;
				}
				default:
					throw new Error(`Unknown field ID: ${fieldHeader.fieldId}`);
	...
	write(writer: BinaryWriter): void {
		...
		if (fields[9]) {
			writer.writeFieldHeader(Shapes.UVARINT, 9);
			writeBool(writer, this.rightClick!); // typescript linters cannot see, that we already checked this properly above
		}
	}
...
export type FlowChartToolbarAction = number;
function writeTypeHeaderFlowChartToolbarAction(dst: BinaryWriter): void {
	dst.writeTypeHeader(Shapes.UVARINT, 254);
	return;
}
// companion enum containing all defined constants for FlowChartToolbarAction
export enum FlowChartToolbarActionValues {
	FlowChartToolbarActionAutoLayout = 1,
}

// FlowChartToolbarActions is a list of predefined actions of the flow chart toolbar.
export class FlowChartToolbarActions implements Writeable, Readable {
	public value: FlowChartToolbarAction[];

	constructor(value: FlowChartToolbarAction[] = []) {
		this.value = value;
	}
	...
	write(writer: BinaryWriter): void {
		writer.writeUvarint(this.value.length); // Write the length of the array
		for (const c of this.value) {
			writeTypeHeaderFlowChartToolbarAction(writer);
			writeInt(writer, c);
	...
	read(reader: BinaryReader): void {
		const count = reader.readUvarint(); // Read the length of the array
		const values: FlowChartToolbarAction[] = [];

		for (let i = 0; i < count; i++) {
			const obj = unmarshal(reader); // Read and unmarshal each component
			values.push(obj as any as FlowChartToolbarAction); // Cast and add to the array
		}

		this.value = values;
	}
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.ARRAY, 255);
		return;
	}
}

// FlowChartToolbar represents a flow chart's toolbar.
export class FlowChartToolbar implements Writeable, Readable {
	public position?: FlowChartToolbarPosition;

	public orientation?: Orientation;

	public actions?: FlowChartToolbarActions;

	constructor(
		position: FlowChartToolbarPosition | undefined = undefined,
		orientation: Orientation | undefined = undefined,
		actions: FlowChartToolbarActions | undefined = undefined
	) {
		this.position = position;
		this.orientation = orientation;
	...
	read(reader: BinaryReader): void {
		...
		for (let i = 0; i < fieldCount; i++) {
			...
			switch (fieldHeader.fieldId) {
				...
				case 3: {
					this.actions = new FlowChartToolbarActions();
					this.actions.read(reader);
					break;
				}
				default:
					throw new Error(`Unknown field ID: ${fieldHeader.fieldId}`);
	...
	write(writer: BinaryWriter): void {
		const fields = [
			...
			this.position !== undefined,
			this.orientation !== undefined,
			this.actions !== undefined && !this.actions.isZero(),
		];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.UVARINT, 1);
			writeInt(writer, this.position!); // typescript linters cannot see, that we already checked this properly above
		}
		if (fields[2]) {
			writer.writeFieldHeader(Shapes.UVARINT, 2);
			writeInt(writer, this.orientation!); // typescript linters cannot see, that we already checked this properly above
		...
		if (fields[3]) {
			writer.writeFieldHeader(Shapes.ARRAY, 3);
			this.actions!.write(writer); // typescript linters cannot see, that we already checked this properly above
		}
	}
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 256);
		return;
	}
}

// FlowChartToolbarPosition describes the position of the flow chart's toolbar.
export type FlowChartToolbarPosition = number;
function writeTypeHeaderFlowChartToolbarPosition(dst: BinaryWriter): void {
	dst.writeTypeHeader(Shapes.UVARINT, 257);
	return;
}
// companion enum containing all defined constants for FlowChartToolbarPosition
export enum FlowChartToolbarPositionValues {
	FlowChartToolbarPositionTopRight = 0,
	FlowChartToolbarPositionCenterRight = 1,
	FlowChartToolbarPositionBottomRight = 2,
	FlowChartToolbarPositionBottomCenter = 3,
	FlowChartToolbarPositionBottomLeft = 4,
	FlowChartToolbarPositionCenterLeft = 5,
	FlowChartToolbarPositionTopLeft = 6,
	FlowChartToolbarPositionTopCenter = 7,
}

export class FlowChartAutoLayout implements Writeable, Readable, CallArgs {
	// Dummy is needed for the event to not be purged out.
	public dummy?: Uint;

	constructor(dummy: Uint | undefined = undefined) {
		this.dummy = dummy;
	}
	...
	write(writer: BinaryWriter): void {
		const fields = [false, this.dummy !== undefined];
		let fieldCount = fields.reduce((count, present) => count + (present ? 1 : 0), 0);
		writer.writeByte(fieldCount);
		if (fields[1]) {
			writer.writeFieldHeader(Shapes.UVARINT, 1);
			writeInt(writer, this.dummy!); // typescript linters cannot see, that we already checked this properly above
		}
	}

	isZero(): boolean {
		return this.dummy === undefined;
	}
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 258);
		return;
	}
	isCallArgs(): void {}
}
...
export class Fieldset implements Writeable, Readable, Component {
	public children?: Components;
	...
	writeTypeHeader(dst: BinaryWriter): void {
		dst.writeTypeHeader(Shapes.RECORD, 283);
		return;
	}
	isComponent(): void {}
}
...
export function unmarshal(src: BinaryReader): any {
	...
	switch (typeId) {
		...
		case 158: {
			const v = new LineChart();
			v.read(src);
			return v;
		}
		case 159: {
			const v = readInt(src) as LineChartCurve;
			return v;
		}
		case 160: {
			const v = new ChartSeriesArray();
			v.read(src);
			return v;
		}
		case 161: {
			const v = readInt(src) as ChartSeriesType;
			return v;
		}
		case 162: {
			const v = new ChartDataPoints();
			v.read(src);
			return v;
		}
		case 163: {
			const v = new ChartDataPoint();
			v.read(src);
			return v;
		}
		case 164: {
			const v = new ChartSeries();
			v.read(src);
			return v;
		}
		case 165: {
			const v = new LineChartMarkers();
			v.read(src);
			return v;
		}
		case 166: {
		...
		case 233: {
			const v = new FlowChart();
			v.read(src);
			return v;
		}
		case 234: {
			const v = new FlowChartPoint();
			v.read(src);
			return v;
		}
		case 235: {
			const v = readInt(src) as FlowChartNodeType;
			return v;
		}
		case 236: {
			const v = new FlowChartNode();
			v.read(src);
			return v;
		}
		case 237: {
			const v = new FlowChartNodes();
			v.read(src);
			return v;
		}
		case 238: {
			const v = readInt(src) as FlowChartEdgeStyle;
			return v;
		}
		case 239: {
			const v = readInt(src) as FlowChartEdgeMarker;
			return v;
		}
		case 240: {
			const v = new FlowChartEdge();
			v.read(src);
			return v;
		}
		case 241: {
			const v = new FlowChartEdges();
			v.read(src);
			return v;
		}
		case 242: {
			const v = new FlowChartModel();
			v.read(src);
			return v;
		}
		case 243: {
			const v = new FlowChartCustomContent();
			v.read(src);
			return v;
		}
		case 244: {
		...
		case 254: {
			const v = readInt(src) as FlowChartToolbarAction;
			return v;
		}
		case 255: {
			const v = new FlowChartToolbarActions();
			v.read(src);
			return v;
		}
		case 256: {
			const v = new FlowChartToolbar();
			v.read(src);
			return v;
		}
		case 257: {
			const v = readInt(src) as FlowChartToolbarPosition;
			return v;
		}
		case 258: {
