...
//TODO: nago example erweitern um ein Formular, das ich abschicke bzw. Datei Upload, um da das Fehlerhandling z.B. Internet vorhanden
// testen.
...
<template>
  <div>
    ...
    <div v-if="errorHandler.error.value" class="flex justify-center items-center h-screen">
     <UiErrorMessage :error="errorHandler.error.value">
     </UiErrorMessage>
     <!--
