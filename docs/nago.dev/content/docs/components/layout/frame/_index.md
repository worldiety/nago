...
| `Grow()` | Grow tells the frame to grow inside the available space of a flex stack |
...
| `PreventShrink()` | PreventShrink tells the frame to not shrink inside a flex stack |
