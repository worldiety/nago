...
| Method | Description |
|--------| ------------|
| `Columns(columns int, class core.WindowSizeClass)` | Columns sets a custom number of columns for a specific WindowSizeClass. This allows the layout to adapt responsively to different screen sizes. |
