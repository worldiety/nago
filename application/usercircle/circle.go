...
type Circle struct {
	...
	Groups []group.ID `json:"groups,omitempty" label:"Verwaltbare Gruppen" table-visible:"false" source:"nago.groups" supportingText:"Die hier ausgewählten Gruppen können durch die Administratoren des Kreises hinzügefügt oder entfernt werden. Achtung, wenn Mitglieder auf Basis von Gruppen ermittelt werden, kann der Administrator dieses Kreises seine Nutzer verlieren."`
	...
	MemberRuleUsersBlacklist []user.ID    `label:"Nicht enthaltene Nutzer" table-visible:"false" source:"nago.users" label:"Explizite Nicht-Nutzer" supportingText:"Die hier ausgewählten Nutzer sind in jedem Fall niemals Mitglied dieses Kreises."`
}
