...
func (cmd AddVStackCmd) WorkspaceID() WorkspaceID {
	return cmd.Workspace
}

func (cmd AddVStackCmd) Decide(subject auth.Subject, ws *Workspace) ([]WorkspaceEvent, error) {
	...
	return []WorkspaceEvent{FormVStackAdded{
