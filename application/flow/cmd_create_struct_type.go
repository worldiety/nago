...
func (cmd CreateStructTypeCmd) WorkspaceID() WorkspaceID {
	return cmd.Workspace
}

func (cmd CreateStructTypeCmd) Decide(subject auth.Subject, ws *Workspace) ([]WorkspaceEvent, error) {
	...
	return []WorkspaceEvent{StructTypeCreated{
...
func (cmd CreateStructTypeCmd) cmd() {}
