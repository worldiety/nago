...
func (cmd AppendBoolFieldCmd) WorkspaceID() WorkspaceID {
	return cmd.Workspace
}

func (cmd AppendBoolFieldCmd) Decide(subject auth.Subject, ws *Workspace) ([]WorkspaceEvent, error) {
	...
	return []WorkspaceEvent{BoolFieldAppended{
