...
func (cmd AddHLineCmd) WorkspaceID() WorkspaceID {
	return cmd.Workspace
}

func (cmd AddHLineCmd) Decide(subject auth.Subject, ws *Workspace) ([]WorkspaceEvent, error) {
	...
	return []WorkspaceEvent{FormHLineAdded{
