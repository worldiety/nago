...
var (
	...
	PermResolveTokenRights = permission.Declare[ResolveTokenRights]("nago.token.resolve_token_rights", "Access Token Rechte einsehen", "Träger dieser Berechtigung können rekursiv die Metadaten vorhandener Tokens abrufen.")
)
