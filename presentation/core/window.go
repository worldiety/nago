...
const (
	...
	InputEventInvalidate    = InputEventType(proto.InputEventInvalidate)
	InputEventMouseDown     = InputEventType(proto.InputEventMouseDown)
	InputEventMouseEnter    = InputEventType(proto.InputEventMouseEnter)
	InputEventMouseLeave    = InputEventType(proto.InputEventMouseLeave)
	InputEventMouseOut      = InputEventType(proto.InputEventMouseOut)
	InputEventMouseMove     = InputEventType(proto.InputEventMouseMove)
	InputEventMouseOver     = InputEventType(proto.InputEventMouseOver)
	InputEventMouseUp       = InputEventType(proto.InputEventMouseUp)
	InputEventMouseWheel    = InputEventType(proto.InputEventMouseWheel)
	InputEventPointerLeave  = InputEventType(proto.InputEventPointerLeave)
	InputEventPointerOut    = InputEventType(proto.InputEventPointerOut)
	InputEventPointerOver   = InputEventType(proto.InputEventPointerOver)
	InputEventBlur          = InputEventType(proto.InputEventBlur)
)
