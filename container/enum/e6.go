...
type E6[T1 any, T2 any, T3 any, T4 any, T5 any, T6 any] struct {
	ordinal int
	v       any
}

func (e E6[T1, T2, T3, T4, T5, T6]) With1(t1 T1) E6[T1, T2, T3, T4, T5, T6] {
	return E6[T1, T2, T3, T4, T5, T6]{
		ordinal: 1,
		v:       t1,
	}
}

func (e E6[T1, T2, T3, T4, T5, T6]) With2(t2 T2) E6[T1, T2, T3, T4, T5, T6] {
	return E6[T1, T2, T3, T4, T5, T6]{
		ordinal: 2,
		v:       t2,
	}
...
func (e E6[T1, T2, T3, T4, T5, T6]) With3(t3 T3) E6[T1, T2, T3, T4, T5, T6] {
	return E6[T1, T2, T3, T4, T5, T6]{
		ordinal: 3,
		v:       t3,
	}
...
func (e E6[T1, T2, T3, T4, T5, T6]) With4(t4 T4) E6[T1, T2, T3, T4, T5, T6] {
	return E6[T1, T2, T3, T4, T5, T6]{
		ordinal: 4,
		v:       t4,
	}
...
func (e E6[T1, T2, T3, T4, T5, T6]) With5(t5 T5) E6[T1, T2, T3, T4, T5, T6] {
	return E6[T1, T2, T3, T4, T5, T6]{
		ordinal: 5,
		v:       t5,
	}
...
func (e E6[T1, T2, T3, T4, T5, T6]) With6(t6 T6) E6[T1, T2, T3, T4, T5, T6] {
	return E6[T1, T2, T3, T4, T5, T6]{
		ordinal: 6,
		v:       t6,
	}
...
func (e E6[T1, T2, T3, T4, T5, T6]) Unwrap() any {
	return e.v
}

func (e E6[T1, T2, T3, T4, T5, T6]) MarshalJSON() ([]byte, error) {
	switch e.ordinal {
	case 0:
...
func (e *E6[T1, T2, T3, T4, T5, T6]) UnmarshalJSON(bytes []byte) error {
...
func Match6[T1 any, T2 any, T3 any, T4 any, T5 any, T6 any, R any](e E6[T1, T2, T3, T4, T5, T6], f1 func(T1) R, f2 func(T2) R, f3 func(T3) R, f4 func(T4) R, f5 func(T5) R, f6 func(T6) R) R {
	switch e.ordinal {
