...
type E9[T1 any, T2 any, T3 any, T4 any, T5 any, T6 any, T7 any, T8 any, T9 any] struct {
	ordinal int
	v       any
}

func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) With1(t1 T1) E9[T1, T2, T3, T4, T5, T6, T7, T8, T9] {
	return E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]{
		ordinal: 1,
		v:       t1,
	}
}

func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) With2(t2 T2) E9[T1, T2, T3, T4, T5, T6, T7, T8, T9] {
	return E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]{
		ordinal: 2,
		v:       t2,
	}
...
func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) With3(t3 T3) E9[T1, T2, T3, T4, T5, T6, T7, T8, T9] {
	return E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]{
		ordinal: 3,
		v:       t3,
	}
...
func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) With4(t4 T4) E9[T1, T2, T3, T4, T5, T6, T7, T8, T9] {
	return E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]{
		ordinal: 4,
		v:       t4,
	}
...
func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) With5(t5 T5) E9[T1, T2, T3, T4, T5, T6, T7, T8, T9] {
	return E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]{
		ordinal: 5,
		v:       t5,
	}
...
func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) With6(t6 T6) E9[T1, T2, T3, T4, T5, T6, T7, T8, T9] {
	return E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]{
		ordinal: 6,
		v:       t6,
	}
...
func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) With7(t7 T7) E9[T1, T2, T3, T4, T5, T6, T7, T8, T9] {
	return E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]{
		ordinal: 7,
		v:       t7,
	}
...
func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) With8(t8 T8) E9[T1, T2, T3, T4, T5, T6, T7, T8, T9] {
	return E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]{
		ordinal: 8,
		v:       t8,
	}
...
func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) With9(t9 T9) E9[T1, T2, T3, T4, T5, T6, T7, T8, T9] {
	return E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]{
		ordinal: 9,
		v:       t9,
	}
...
func (e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) MarshalJSON() ([]byte, error) {
	...
	case 9:
		var zero T9
		return json.Marshal(adjacentlyTagged[T9]{
			Type:  reflect.TypeOf(zero).Name(),
			Value: e.v.(T9),
		})
...
func (e *E9[T1, T2, T3, T4, T5, T6, T7, T8, T9]) UnmarshalJSON(bytes []byte) error {
	...
	case reflect.TypeOf(t9.Value).Name():
		if err := json.Unmarshal(bytes, &t9); err != nil {
			return nil
		}
		e.v = t9.Value
		e.ordinal = 9
...
func Match9[T1 any, T2 any, T3 any, T4 any, T5 any, T6 any, T7 any, T8 any, T9 any, R any](e E9[T1, T2, T3, T4, T5, T6, T7, T8, T9], f1 func(T1) R, f2 func(T2) R, f3 func(T3) R, f4 func(T4) R, f5 func(T5) R, f6 func(T6) R, f7 func(T7) R, f8 func(T8) R, f9 func(T9) R) R {
	switch e.ordinal {
