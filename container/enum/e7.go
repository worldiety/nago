...
type E7[T1 any, T2 any, T3 any, T4 any, T5 any, T6 any, T7 any] struct {
	ordinal int
	v       any
}

func (e E7[T1, T2, T3, T4, T5, T6, T7]) With1(t1 T1) E7[T1, T2, T3, T4, T5, T6, T7] {
	return E7[T1, T2, T3, T4, T5, T6, T7]{
		ordinal: 1,
		v:       t1,
	}
}

func (e E7[T1, T2, T3, T4, T5, T6, T7]) With2(t2 T2) E7[T1, T2, T3, T4, T5, T6, T7] {
	return E7[T1, T2, T3, T4, T5, T6, T7]{
		ordinal: 2,
		v:       t2,
	}
...
func (e E7[T1, T2, T3, T4, T5, T6, T7]) With3(t3 T3) E7[T1, T2, T3, T4, T5, T6, T7] {
	return E7[T1, T2, T3, T4, T5, T6, T7]{
		ordinal: 3,
		v:       t3,
	}
...
func (e E7[T1, T2, T3, T4, T5, T6, T7]) With4(t4 T4) E7[T1, T2, T3, T4, T5, T6, T7] {
	return E7[T1, T2, T3, T4, T5, T6, T7]{
		ordinal: 4,
		v:       t4,
	}
...
func (e E7[T1, T2, T3, T4, T5, T6, T7]) With5(t5 T5) E7[T1, T2, T3, T4, T5, T6, T7] {
	return E7[T1, T2, T3, T4, T5, T6, T7]{
		ordinal: 5,
		v:       t5,
	}
...
func (e E7[T1, T2, T3, T4, T5, T6, T7]) With6(t6 T6) E7[T1, T2, T3, T4, T5, T6, T7] {
	return E7[T1, T2, T3, T4, T5, T6, T7]{
		ordinal: 6,
		v:       t6,
	}
...
func (e E7[T1, T2, T3, T4, T5, T6, T7]) With7(t7 T7) E7[T1, T2, T3, T4, T5, T6, T7] {
	return E7[T1, T2, T3, T4, T5, T6, T7]{
		ordinal: 7,
		v:       t7,
	}
...
func (e E7[T1, T2, T3, T4, T5, T6, T7]) Unwrap() any {
	return e.v
}

func (e E7[T1, T2, T3, T4, T5, T6, T7]) MarshalJSON() ([]byte, error) {
	switch e.ordinal {
	case 0:
...
func (e *E7[T1, T2, T3, T4, T5, T6, T7]) UnmarshalJSON(bytes []byte) error {
...
func Match7[T1 any, T2 any, T3 any, T4 any, T5 any, T6 any, T7 any, R any](e E7[T1, T2, T3, T4, T5, T6, T7], f1 func(T1) R, f2 func(T2) R, f3 func(T3) R, f4 func(T4) R, f5 func(T5) R, f6 func(T6) R, f7 func(T7) R) R {
	switch e.ordinal {
